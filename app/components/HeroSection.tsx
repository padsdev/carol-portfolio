...
export default function HeroSection() {
    return (
        <section className="relative container mx-auto px-6 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 overflow-visible">
            ...
            <div className="w-full lg:w-1/2 relative z-10 flex justify-center perspective-[1000px]">
                ...
                <div className="photo-card-container relative aspect-[4/5] w-full max-w-md rounded-[40px] overflow-hidden shadow-2xl bg-secondary/30 group">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left space-y-8 relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                    <Link
                        href="#contact"
                        className="group relative px-10 py-5 rounded-full bg-[#4B4B47] text-white font-bold font-manrope shadow-[0_10px_20px_rgba(75,75,71,0.2)] hover:bg-primary hover:text-white hover:shadow-[0_15px_30px_rgba(212,175,55,0.3)] transition-all duration-400 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] transform hover:-translate-y-[5px] hover:scale-[1.03] overflow-hidden"
                    >
